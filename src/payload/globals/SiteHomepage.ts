...
export const SiteHomepage: GlobalConfig = {
  ...
  fields: [
    ...
    },
    {
      name: 'method',
      type: 'group',
      label: { es: 'Sección Método', en: 'Method Section' },
      fields: [
        {
          name: 'eyebrow',
          type: 'text',
          localized: true,
          admin: { description: 'Eyebrow label sobre el H2 (ej: §6 · Método).' },
        },
        {
          name: 'h2Line1',
          type: 'text',
          localized: true,
          required: true,
          defaultValue: 'Tres servicios coordinados.',
          admin: { description: 'Primera línea del H2 de sección (color primario).' },
        },
        {
          name: 'h2Line2Soft',
        ...
        },
        {
          ...
          fields: [
            ...
            },
            {
              ...
              localized: true,
              required: true,
              admin: { description: 'Rango de duración (ej: 2 – 3 semanas).' },
            },
            {
              name: 'commit',
              type: 'text',
              ...
              required: true,
              admin: {
                description: 'Compromiso del servicio (ej: Alcance cerrado · sin recurrencia).',
              },
            },
            {
              name: 'body',
              ...
              localized: true,
              required: true,
              admin: { description: 'Descripción del servicio (2-3 párrafos breves).' },
            },
            {
              name: 'deliverables',
              type: 'array',
              ...
              admin: { description: 'Lista de entregables del servicio (3-5 items).' },
              fields: [
                {
                  name: 'text',
                  type: 'text',
        ...
        },
        {
          ...
          type: 'text',
          localized: true,
          defaultValue: 'No hay urgencia.',
          admin: { description: 'Primera línea de la cita central (color primario).' },
        },
        {
          name: 'quoteSoft',
          type: 'text',
          localized: true,
          defaultValue: 'Hay método.',
          admin: { description: 'Segunda línea de la cita central (tono muted).' },
        },
        {
          name: 'quoteCaption',
          type: 'text',
          localized: true,
          defaultValue: 'Canon BBF · 01',
          admin: { description: 'Caption bajo la cita (mono-xs, muted).' },
        },
        {
          name: 'ctaText',
          type: 'text',
          localized: true,
          defaultValue: 'Conocer el método completo',
          admin: { description: 'Texto del CTA link-arrow al final de la sección.' },
        },
        {
          name: 'ctaHref',
          type: 'text',
