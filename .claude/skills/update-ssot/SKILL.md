...
> **Nota 05d-web-2:** BBF_WebPublicaRoadmap_v0_1.md fue purgado de bbf-docs en 05c-PURGE.
> Consultar snapshot en: `bbf-docs/docs-pre-hub/sb-web/04-strategic/web-public/BBF_WebPublicaRoadmap_v0_1.md`

`/Volumes/PK/BBF/Repos/bbf-docs/docs-pre-hub/sb-web/04-strategic/web-public/BBF_WebPublicaRoadmap_v0_1.md` — busca la sección de la capa (ej: §5.1 para H1-1).
...
Output: bloque markdown completo en respuesta. Sugerencia: "Copia este bloque a `bbf-docs/sb-docs/sb-web/02-referencia/BBF_<Capa>SSOT.md` (usar skill `crear-doc` en bbf-docs) y fírmalo cuando lo apruebes."
