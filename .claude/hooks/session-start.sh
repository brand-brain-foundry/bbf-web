...
# 04-strategic/ purgado en bbf-docs 05c-PURGE — snapshots en docs-pre-hub/
CANON_PATH="$DOCS_DIR/docs-pre-hub/sb-web/04-strategic/web-public/BBF_WebPublicaTopologiaCanon_v0_3.md"
ROADMAP_PATH="$DOCS_DIR/docs-pre-hub/sb-web/04-strategic/web-public/BBF_WebPublicaRoadmap_v0_1.md"
SBLAW_PATH="$DOCS_DIR/docs-pre-hub/sb-web/00-context/SB_Law_Construction.md"
TAX_PATH="$DOCS_DIR/docs-pre-hub/sb-web/00-context/SB_TaxComponentes.md"

CANON_OK="❌ (snapshot legacy)"
[ -f "$CANON_PATH" ] && CANON_OK="✅ (snapshot docs-pre-hub)"
ROADMAP_OK="❌ (snapshot legacy)"
[ -f "$ROADMAP_PATH" ] && ROADMAP_OK="✅ (snapshot docs-pre-hub)"
SBLAW_OK="❌"
...
CONTEXT=$(cat <<EOF
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
SESIÓN bbf-web (web pública Sivar Brains) — session-start.sh
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Branch: $BRANCH ($DIRTY archivos sin commit)

Doctrina (snapshots legacy — GUÍA, no obedecer):
  $DOCS_NOTE
  $SBLAW_OK SB_Law_Construction.md (docs-pre-hub)
  $TAX_OK SB_TaxComponentes.md (docs-pre-hub)
  $CANON_OK BBF_WebPublicaTopologiaCanon_v0_3.md (docs-pre-hub/04-strategic)
  $ROADMAP_OK BBF_WebPublicaRoadmap_v0_1.md (docs-pre-hub/04-strategic)
